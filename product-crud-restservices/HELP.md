...
* The original package name 'com.usecase.product.product-crud-restservices' is invalid and this project uses 'com.usecase.product.productcrudrestservices' instead.
